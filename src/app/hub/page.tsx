...
const SECTIONS: Section[] = [
  ...
  { href: "/explore",        label: "Explore Anime",   desc: "Search every series, filtered how you like.",      Icon: Compass,      tint: "#818cf8" },
  { href: "/manhwa/explore", label: "Explore Comics",  desc: "Browse manhwa, manga and manhua.",                 Icon: Compass,      tint: "#38bdf8" },
  { href: "/novel/explore",  label: "Explore Novels",  desc: "Browse every source at once.",                     Icon: Compass,      tint: "#fbbf24" },
