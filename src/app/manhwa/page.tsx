...
function ManhwaPageInner() {
  ...
  const wbcItems = dedupeById([...trending, ...latestUpdates].filter((m) => m.id.startsWith("wbc:")));
              ...
              <div className="pt-6">
                <DiscoverRail
                  ...
                  tabs={[
                    ...
                    ...(wbcItems.length > 0 ? [{ key: "weebcentral", label: "WeebCentral", icon: "trending" as const, items: toDiscover(wbcItems) }] : []),
