            ...
            <div className="max-w-[1300px] mx-auto px-4 md:px-8">
              <div className="flex flex-col lg:flex-row gap-8">
                                ...
                                manhwa.latest_chapters.slice(0, 3).map((chapter, offset) => {
                                  ...
                                  return (
                                    <div key={chapter.id} className="flex items-center justify-between text-[11px]">
                                      ...
                                      <span className="text-[#737373] whitespace-nowrap">{timeText}</span>
                                    </div>
                                  );
                                })
                              ) : (
                                <div className="text-[11px] text-slate-500 italic">No chapters available</div>
                              )}
                            </div>
                          </div>
                        </div>
                ...
                <div className="w-full lg:w-[320px] flex flex-col gap-8">
                  {/* Popular Comics Panel */}
                  <div className="bg-[#151518] rounded-xl border border-[#2a2a32] p-5 shadow-lg">
                    <div className="flex items-center justify-between mb-5 pb-3 border-b border-[#2a2a32]">
                      <div className="flex items-center gap-2">
                        <Flame className="w-5 h-5 text-orange-500" />
                        <h2 className="font-black text-white">Popular</h2>
                      </div>
                    </div>
                    
                    <div className="flex items-center gap-1 bg-[#0b0b0c] p-1 rounded-lg mb-5 border border-[#2a2a32]">
                      <button 
