...
const SHOP_ITEMS = [
  ...
  { id: "effect_dandadan", type: "effect", sss: true, name: "Dandadan: The Turbo Clash", description: "「 You believe in ghosts? Aliens? WRONG ANSWER. 」 Your profile becomes a warzone between two realities. LEFT: toxic-green abduction beams drop from above while saucers, wireframe pyramids and math-grids GLITCH into existence in blinding cyan. RIGHT: viscous cursed ink — clawed ghost-hands and manga scribbles — tears in from the edge, ignoring gravity entirely. A crackling white seam splits the world straight through your avatar… until the dash: neon streaks cross the whole card in TWO FRAMES, reality slices into bands and rips sideways like a broken VHS with its colors split apart, and both energies crash into your avatar in a jagged 22-point comic-book blast. What remains: a roaring dual-tone aura — alien fire on one side, cursed fire on the other — while teeth, UFO crosshairs and red spirit-orbs float UPWARD in eerie zero gravity and the whole card tilts a few surreal degrees off its axis. Then it happens again. Your name burns both colors for as long as it is equipped. SSS grade.", price: 14000, icon: Ghost, color: "text-fuchsia-400", glow: "shadow-[0_0_26px_rgba(255,0,255,0.7)]", gradient: "from-lime-300 via-cyan-400 to-fuchsia-500" },
  { id: "effect_grandline", type: "effect", sss: true, name: "The Grand Line", description: "「 I’m going to be King of the Pirates! 」 Your profile sets sail on the Grand Line. A four-layer procedural ocean rolls across the card at golden hour — deep navy swells in the back, bright tropical crests in front breaking into real seafoam — while a fully hand-drawn mahogany galleon rides it on TRUE buoyancy physics: the hull reads the exact height and slope of the water beneath its keel every frame, climbing swells, pitching over crests, and throwing white-and-cyan bow-spray when it crashes down into a trough. Golden lion figurehead. Three billowing sails. A skull-and-crossbones drawn stroke by stroke on the mainsail, and a black pennant snapping at the masthead. Above deck: seagulls flap through the sunset, wind streaks race the sky, and a sun-glitter road shimmers on the water. Your avatar becomes the bounty: a torn-parchment poster ring, warm god-rays sweeping the whole card, and golden ฿ marks orbiting your head. Your name gleams sunset-gold into ocean-cyan for as long as it is equipped. SSS grade. The sea never stops.", price: 15000, icon: Ship, color: "text-amber-400", glow: "shadow-[0_0_26px_rgba(255,183,71,0.7)]", gradient: "from-amber-300 via-orange-400 to-cyan-500" },
