...
import { MountainSnow, ShoppingBag, Sparkles, Check, Diamond, Aperture, CircleDot, Orbit, Snowflake, Flame, Sun, Zap, Leaf, Search, X, LayoutGrid, CloudLightning, CloudFog, Moon, Cog, Target, Trees, Gift, Swords, Flower2, Skull, Sprout, Eye, ArrowRight, Infinity as InfinityIcon, History, Hourglass, Atom, Shell, Tag, Key } from "lucide-react";
...
const SHOP_ITEMS = [
  ...
  { id: "effect_gateway", type: "effect", sss: true, name: "The Gate & The Key", description: "「 It knows the gate. It IS the gate. 」 Sacred geometry gone wrong. Behind your avatar, a wireframe TESSERACT — a true four-dimensional hypercube, projected down into our poor three — turns slowly inside a counter-rotating dodecahedron of corrupted gold, both drawn in solid burning light. Around them drifts a cluster of conjoined iridescent spheres, breathing and phasing through one another like boiling cosmic bubbles — each one carrying a single lidless golden iris that always faces the gateway. Hundreds of gold and ultraviolet motes orbit through three impossible spiral arms that never repeat. And every twelve to eighteen seconds, the viewer's mind briefly UNDERSTANDS what it is looking at: reality inverts to a hard alien negative while corrupted EKG waveforms tear across the geometry — then snaps back to serene, glowing calm as if nothing happened. Nothing happened. SSS grade.", price: 12000, icon: Key, color: "text-violet-300", glow: "shadow-[0_0_26px_rgba(138,43,226,0.75)]", gradient: "from-violet-400 via-purple-900 to-amber-400" },
