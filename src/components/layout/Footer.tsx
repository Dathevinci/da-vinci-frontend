...
export default function Footer() {
  return (
    <footer className="relative mt-20 border-t border-white/10 overflow-hidden bg-[#050505]">
      {/* Decorative Glows */}
      <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-indigo-600/10 rounded-full blur-[120px] pointer-events-none transform -translate-y-1/2"></div>
          ...
          <div className="lg:col-span-4 space-y-6">
            <Link href="/" className="flex items-center gap-3 group inline-flex font-fell font-bold text-3xl tracking-[0.15em] uppercase drop-shadow-md">
              <div className="relative">
                <div className="absolute inset-0 bg-indigo-500/20 blur-xl rounded-full group-hover:bg-purple-500/30 transition-all duration-500"></div>
                <img src="/logo.png" alt="Da Vinci Logo" className="relative w-12 h-12 rounded-full border-2 border-indigo-500/30 object-cover group-hover:border-purple-400/50 transition-all duration-500" />
              </div>
              <span className="text-white group-hover:text-indigo-100 transition-all duration-300">
            ...
            <div className="pt-2 flex flex-col gap-3">
              <a 
                ...
                className="inline-flex items-center justify-center gap-2.5 px-5 py-2.5 bg-[#5865F2]/10 hover:bg-[#5865F2]/20 border border-[#5865F2]/20 hover:border-[#5865F2]/50 text-indigo-100 text-sm font-semibold rounded-xl transition-all duration-300 group w-fit"
              >
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-3.5 text-slate-400 font-medium">
              {[
                ...
                <li key={link.name}>
                  <Link href={link.href} className="group hover:text-indigo-300 transition-all duration-300 inline-flex items-center gap-2">
                    <ChevronRight className="w-3.5 h-3.5 opacity-0 -ml-4 group-hover:opacity-100 group-hover:ml-0 text-indigo-500 transition-all duration-300" />
                    {link.name}
                  </Link>
                </li>
              ))}
