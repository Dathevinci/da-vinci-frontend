      ...
      <div className="relative">
        ...
        >
          ...
          <Link href={seeAllLink} className="snap-start shrink-0">
            <div className="relative w-[132px] sm:w-[150px] md:w-[178px] aspect-[2/3] rounded-lg flex items-center justify-center bg-[#141414]/40 border border-white/5 hover:bg-[#141414]/80 transition-colors cursor-pointer group/card hover:scale-105 duration-300 hover:shadow-[0_0_30px_rgba(147,51,234,0.2)] hover:border-[#9333ea]/40">
              <div className="flex flex-col items-center gap-3">
                <div className="w-14 h-14 rounded-full border-2 border-white/10 flex items-center justify-center group-hover/card:border-[#9333ea] transition-colors bg-black/40 shadow-lg">
                  <ChevronRight className="w-8 h-8 text-white group-hover/card:translate-x-1 group-hover/card:text-[#9333ea] transition-all" />
                </div>
        ...
        >
          <ChevronRight className="w-6 h-6 md:w-8 md:h-8 text-white hover:text-[#9333ea]" />
        </button>
      </div>
    </div>
  );
