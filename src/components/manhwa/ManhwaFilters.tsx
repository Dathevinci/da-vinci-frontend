    ...
    <div className="w-full">
      <form onSubmit={(e) => { e.preventDefault(); apply(); }} className="relative">
        <input
          ...
          className="w-full bg-[#151518] border border-white/10 rounded-xl py-3 pl-11 pr-4 text-sm focus:outline-none focus:border-purple-500/50 transition-colors text-white placeholder:text-slate-500"
        />
        ...
        <div className="mt-3 flex flex-col gap-3 bg-white/[0.03] border border-white/5 rounded-xl p-4">
          <div>
            ...
            <select
              ...
              className="w-full bg-[#151518] border border-white/10 rounded-lg py-2 px-3 text-sm text-white focus:outline-none focus:border-purple-500/50"
            >
          ...
          <div className="flex gap-2 mt-1">
            <button onClick={apply} className="flex-1 bg-purple-600 hover:bg-purple-500 text-white font-bold py-2 rounded-lg text-sm transition">
              Apply
            </button>
