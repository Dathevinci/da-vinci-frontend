...
export default function ImageCropperModal({ imageSrc, isBanner, onClose, onCropComplete }: ImageCropperModalProps) {
      ...
      >
        ...
        <div className="p-6 bg-[#1a1a1a] flex flex-col gap-6">
          ...
          <div className="flex justify-end gap-3">
            ...
            <button 
              onClick={handleSave}
              className="px-6 py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white rounded-lg font-bold shadow-lg flex items-center gap-2 transition"
            >
